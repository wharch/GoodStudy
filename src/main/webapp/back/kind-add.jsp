...
<div class="wrapper">
    ...
    <div class="page-content">
        <div class="content">
            <!-- 右侧内容框架，更改从这里开始 -->
            <form class="layui-form" action="<%=application.getContextPath()%>/kind?op=addKind" method="post">
                <div class="layui-form-item">
                    <label>类别名 Name</label>
                    <input type="text" name="name" value="" placeholder="课程类别" required>
                </div>
                <div class="layui-form-item">

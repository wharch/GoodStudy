...
<%--                        </div>--%>
    ...
    <div>
        <c:forEach items="${courses.data}" var="cou">
            <c:if test="${cou.cStatus==1}">
                <!-- Course Block -->
...
<%--                            <div class="time">03 hours</div>--%>
                        ...
                        <div class="lower-content">
                            ...
                            <div class="clearfix">
                                <div class="pull-left">
                                    <div class="author">任课教师: <span>${cou.teacher.tName}</span></div>
                                </div>
                                <div class="pull-right">
                                    <c:if test="${cou.cPrice<=0}">
                                        <div class="price">免费</div>
                                    </c:if>
                                    <c:if test="${cou.cPrice>0}">
                                        <div class="price">$${cou.cPrice}</div>
                                    </c:if>
                                </div>
                            </div>
                        </div>
...
<!-- Post Share Options -->
<div class="styled-pagination margin-top text-center" style="clear: both">
    <ul class="clearfix">
        <li class="arrow"><a
                href="<%=application.getContextPath()%>/course?op=pageFindAllCourse&key=${cn}&pageNum=${courses.prev()}"><span
                class="fa fa-angle-left"></span> </a></li>
        <li class="prev"><a
                href="<%=application.getContextPath()%>/course?op=pageFindAllCourse&key=${cn}&pageNum=${courses.prev()}">上一页</a>
        </li>
        <%--            <li><a href="#">2</a></li>--%>
        <%--            <li class="active"><a href="#">3</a></li>--%>
        <%--            <li><a href="#">4</a></li>--%>
        <%--            <li><a href="#">5</a></li>--%>
        <c:forEach var="i" begin="1" end="${courses.totalPageCount()}">
            <li><a href="<%=application.getContextPath()%>/course?op=pageFindAllCourse&key=${cn}&pageNum=${i}">${i}</a></li>
        </c:forEach>
        <li class="next"><a
                href="<%=application.getContextPath()%>/course?op=pageFindAllCourse&key=${cn}&pageNum=${courses.next()}">下一页</a>
        </li>
        <li class="arrow"><a
                href="<%=application.getContextPath()%>/course?op=pageFindAllCourse&key=${cn}&pageNum=${courses.next()}"><span

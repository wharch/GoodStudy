...
<div class="page-wrapper">
                            ...
                            <nav class="main-menu navbar-expand-md">
                                ...
                                <div class="navbar-collapse collapse clearfix" id="navbarSupportedContent">
                                    <ul class="navigation clearfix">
                                        ...
                                        <li class="dropdown"><a href="#">指导员</a>
                                            <ul>
    ...
    <!-- Sign Up Section -->
    <section class="signup-section" style="background-image:url(images/background/pattern-4.png)">
        <div class="auto-container">
            <div class="logo">
                <a href="index.html"><img src="images/logo-3.png" alt="" /></a>
            </div>
            <div class="inner-container">
                <h2><span class="theme_color">学生注册</span></h2>
                <div class="text">Student registration</div>

                <!-- Login Form -->
                <div class="styled-form">
                    <form method="post" class="layui-form" action="<%=application.getContextPath()%>/admin?op=addStudent" method="post"enctype="multipart/form-data">
                        ...
                        <div class="row clearfix">
                            ...
                            <tr>
                                ...
                                <div class="layui-form-item">
                                    <label  class="xingbie">性别 Gender</label><br>
                                        男<input type="radio" name="gender" value="男" title="男">
                            ...
                            <div class="form-group col-lg-6 col-md-12 col-sm-12">
                                ...
                                <input type="date" name="birthday" value="" placeholder="birthday" required>
                            </div>

                            <!-- Form Group -->
                            <div class="form-group col-lg-6 col-md-12 col-sm-12">
                                <label>邮箱 Email</label>
                                <input type="email" name="email" value="" placeholder="abcd@qq.com" required>
                            </div>
                            ...
                            <!-- Form Group -->
                                <div class="form-group col-lg-6 col-md-12 col-sm-12">
                                    <label>头像 Head</label>
                                    <input type="file" name="stu_head_img" multiple>
                                </div>
            ...
            <div class="form-group col-lg-12 col-md-12 col-sm-12 text-center">
                <button type="submit" class="theme-btn btn-style-one"><span class="txt">立即注册</span></button>
            </div>

            <div class="form-group col-lg-12 col-md-12 col-sm-12">
                <div class="users">注册成功？ <a href="login.html">登录</a></div>
            </div>
